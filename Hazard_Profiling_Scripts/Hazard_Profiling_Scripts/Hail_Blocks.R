...
Hail_raster <- raster("Hail_days_per_year.tif")

setwd("E:/SHMP/Risk Assesment/Shapefile")
LA_census_blocks_2020 <- st_read("Louisiana_Census_Blocks_2020.shp")


LA_census_blocks_2020$Hail <- exact_extract(Hail_raster, LA_census_blocks_2020, 'mean')


setwd("E:/SHMP/Block_historical_hazard_intensity_shapefiles")
st_write(LA_census_blocks_2020, "LA_blocks_2020_Hail.shp")
